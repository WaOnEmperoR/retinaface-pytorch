...
if __name__ == "__main__":
  ...
  model = tvmodels.convnext_tiny(pretrained=True)  # or weights=models.ConvNeXt_Tiny_Weights.DEFAULT for newer versions
...
#   print_layer_info(model)
  ...
  # yy = _utils.IntermediateLayerGetter(model, {'layer2': 1, 'layer3': 2, 'layer4': 3})
  ...
  output = getter(torch.rand(1, 3, 224, 224))
